...
X1 <- tidy(Modonset1, exponentiate = FALSE, conf.int = TRUE, conf.level = 0.95) %>% dplyr::mutate(ds = "Onset timing 2021", yr = 2022) %>% dplyr::filter(term != "(Intercept)")
...
DSregressMv %>%
  ...
  dplyr::select(1, 3,6,9,12, 4,7,10,13, 5,8,11,14)
