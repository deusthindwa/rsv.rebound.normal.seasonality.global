...
onset_overall <-
  ...
  dplyr::mutate(w1corr = round((circular::cor.circular(sin(precov), sin(wave1)))[1], digits = 2),
                ...
                w1L = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave1)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[2], digits = 2),
                w1U = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave1)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[3], digits = 2),
                w2L = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave2)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[2], digits = 2),
                w2U = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave2)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[3], digits = 2),
                w3L = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave3) %>% dplyr::filter(!is.na(wave3))), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[2], digits = 2),
                w3U = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave3) %>% dplyr::filter(!is.na(wave3))), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[3], digits = 2),
                cat = "Overall") %>%
...
for (j in c("Northern hemisphere", "Southern hemisphere")) {
  scatterXY[[j]] =
    ...
    dplyr::mutate(w1corr = round((circular::cor.circular(sin(precov), sin(wave1)))[1], digits = 2),
                  ...
                  w1L = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave1, hemi) %>% dplyr::filter(hemi ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[2], digits = 2),
                  w1U = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave1, hemi) %>% dplyr::filter(hemi ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[3], digits = 2),
                  w2L = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave2, hemi) %>% dplyr::filter(hemi ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[2], digits = 2),
                  w2U = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave2, hemi) %>% dplyr::filter(hemi ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[3], digits = 2),
                  w3L = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave3, hemi) %>% dplyr::filter(!is.na(wave3), hemi ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[2], digits = 2),
                  w3U = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave3, hemi) %>% dplyr::filter(!is.na(wave3), hemi ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[3], digits = 2))
}
...
for (j in c("Tropical", "Temperate")) {
  scatterXY[[j]] =
    ...
    dplyr::mutate(w1corr = round((circular::cor.circular(sin(precov), sin(wave1)))[1], digits = 2),
                  ...
                  w1L = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave1, clim) %>% dplyr::filter(clim ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[2], digits = 2),
                  w1U = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave1, clim) %>% dplyr::filter(clim ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[3], digits = 2),
                  w2L = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave2, clim) %>% dplyr::filter(clim ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[2], digits = 2),
                  w2U = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave2, clim) %>% dplyr::filter(clim ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[3], digits = 2),
                  w3L = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave3, clim) %>% dplyr::filter(!is.na(wave3), clim ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[2], digits = 2),
                  w3U = round(boot.ci(boot(as.data.frame(onsetb %>% dplyr::select(precov, wave3, clim) %>% dplyr::filter(!is.na(wave3), clim ==j)), function(i,d) circular::cor.circular(sin(i[d,1]), sin(i[d,2])), R=1000), type = "norm")$normal[3], digits = 2))
}
